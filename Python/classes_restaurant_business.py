...
# Early Bird Menu
early_bird_items =  {
  'Salumeria plate': 8.00, 'salad and breadstick(serves 2, no refills)': 14.00, 'pizza with quattro formaggi': 9.00, 'duck ragu': 17.50, 'mushroom ravioli (vegan)': 13.50, 'coffee': 1.50, 'espresso': 3.00}
